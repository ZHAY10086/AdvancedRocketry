...
public class ARConfiguration {
    ...
    public static void loadPreInit() {
        ...
        arConfig.solarArrayMaxOutput = config.get(ENERGY, "solarArrayMaxOutput", 8192, "Maximum final generated RF/t from a complete Solar Array. A station orbiting Sol reaches this value. Does not use solarGeneratorMultiplier.", 0, Integer.MAX_VALUE).getInt();
